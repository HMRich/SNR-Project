...
public class AI
{
	...
	AI setHealthThreshold(double healthThreshold)
	{
	...
	AI setSwitchThreshold(AttackEffectiveness switchThreshold)
	{
	...
	AI setMoveThreshold(AttackEffectiveness moveThreshold)
	{
	...
	public AiMoveChoice chooseMove(Anature source, Anature target)
	{
		...
		ArrayList<AiMoveChoice> choices = generateMoveChoiceList(source, target);
	...
	private ArrayList<AiMoveChoice> generateMoveChoiceList(Anature source, Anature target)
	{
