...
{
	private static IAnature setAnatureTypes(Type[] types)
	{
		return TestObjects.getAnature().getClone().withPrimaryType(types[0]).withSecondaryType(types[1]).create();
	}
	...
	static IAnature t(Type[] targetTypes)
	{
